...
whats = [
    ...
    ('debug-hgc2',[
        ("TC",     "L1HGCalTC$",    ROOT.kOrange+3,  25, 2.0),
        ("2D",     "L1HGCal2D$",      ROOT.kRed+1,  25, 1.6),
        ("3D",     "L1HGCal3D$",    ROOT.kRed+0,     20, 1.4),
        #("PF_Raw",     "L1RawHGCal$",   ROOT.kGreen+2,   21, 0.8),
        ("3D_Corr",    "L1HGCal$",      ROOT.kViolet+1,  20, 1.1),
    ]),
    ('debug-hgc3',[
        ("2D",     "L1HGCal2D$",     ROOT.kRed+1,  25, 1.6),
        ("3D",     "L1HGCal3D$",     ROOT.kRed+1,     21, 1.4),
        #("Akt050", "L1HGCalAKT050$",  ROOT.kPink+10,  20, 1.1),
        ("Akt070", "L1HGCalAKT070$",  ROOT.kViolet+1,  20, 1.1),
        #("Akt100", "L1HGCalAKT100$",  ROOT.kAzure+1,   20, 1.1),
        ("Akt120", "L1HGCalAKT120$",  ROOT.kAzure+1,  20, 1.1),
        #("Akt150", "L1HGCalAKT150$",  ROOT.kAzure+1,  20, 1.1),
        ("Akt200", "L1HGCalAKT200$",  ROOT.kGreen+2,  20, 1.1),
        #("Akt250", "L1HGCalAKT250$",  ROOT.kGreen+1,  20, 1.1),
    ]),
    ('debug-hgc4',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  20, 1.2),
        ("2D",     "L1HGCal2D$",     ROOT.kRed+1,  25, 2.0),
        ("3D",     "L1HGCal3D$",     ROOT.kRed+1,     21, 1.6),
        ("3D_S0",  "L1HGCal3DS0$",     ROOT.kGreen+1,  21, 1.3),
        ("3D_T2",  "L1HGCal3DT2$",     ROOT.kAzure+1,  21, 1.0),
        ("Akt12_pt2", "L1HGCalAKT120ptCut$",  ROOT.kViolet+2,  24, 1.0),
        ("Akt12_pt1", "L1HGCalAKT120$",  ROOT.kViolet+0,  20, 0.8),
    ]),
    ('debug-hgc4a',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  20, 1.2),
        ("2D",     "L1HGCal2D$",     ROOT.kRed+1,  25, 1.6),
        ("3D",     "L1HGCal3D$",     ROOT.kRed+1,     21, 1.4),
        ("3D_S0",  "L1HGCal3DS0$",     ROOT.kGreen+1,     20, 1.2),
        ("3D_S1",  "L1HGCal3DS1$",     ROOT.kCyan+0,     20, 1.0),
        ("3D_S2",  "L1HGCal3DS2$",     ROOT.kAzure+2,     20, 0.8),
    ]),
    ('debug-hgc4b',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  20, 1.2),
        ("2D",     "L1HGCal2D$",     ROOT.kRed+1,  25, 1.6),
        ("3D",     "L1HGCal3D$",     ROOT.kRed+1,     21, 1.4),
        ("3D_S0",  "L1HGCal3DS0$",     ROOT.kGreen+1,   20, 1.2),
        ("3D_T1",  "L1HGCal3DT1$",     ROOT.kViolet+1,  20, 1.0),
        ("3D_T2",  "L1HGCal3DT2$",     ROOT.kBlue+2,    20, 0.8),
    ]),
   ('test-hgc0',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  20, 1.2),
        ("2D",      "L1HGCal2D$",              ROOT.kGreen+2,  25, 1.6),
        ("3D",      "L1HGCal3DRef$",           ROOT.kAzure+1,  21, 1.3),
        ("Unclust", "L1HGCal3DRefUnclust$",    ROOT.kRed+1,    24, 1.2),
    ]),
    ('test-hgc1',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  20, 1.2),
        ("2D",     "L1HGCal2D$",      ROOT.kOrange+4, 25, 2.0),
        ("3D_Ref", "L1HGCal3DRef$",   ROOT.kRed+2,    21, 1.6),
        ("3D_S0",  "L1HGCal3DS0$",    ROOT.kGreen+3,  21, 1.3),
        ("3D_T2",  "L1HGCal3DT2$",    ROOT.kAzure+2,  21, 1.0),
        ("Akt12",  "L1HGCal3DAKT12$", ROOT.kViolet-3, 21, 0.8),
    ]),
    ('test-hgc2',[
        ("Ref",     "L1HGCal3DRef$",           ROOT.kRed+2,    21, 1.6),
        ("Ref_Unc", "L1HGCal3DRefUnclust$",    ROOT.kRed+2,    25, 1.6),
        ("S0",      "L1HGCal3DS0$",            ROOT.kGreen+3,  21, 1.3),
        ("S0_Unc",  "L1HGCal3DS0Unclust$",     ROOT.kGreen+3,  25, 1.3),
        ("T2",      "L1HGCal3DT2$",            ROOT.kAzure+2,  21, 1.0),
        ("T2_Unc",  "L1HGCal3DT2Unclust$",     ROOT.kAzure+2,  25, 1.0),
        ("Akt",     "L1HGCal3DAKT12$",         ROOT.kViolet-3, 21, 0.8),
        ("Akt_Unc", "L1HGCal3DAKT12Unclust$",  ROOT.kViolet-3, 25, 0.8),
    ]),
    ('test-hgc3',[
        ("Ref_Raw",  "L1HGCal3DRef$",        ROOT.kRed+2,    21, 1.6),
        ("Ref_Corr", "L1HGCal3DRefCorr$",    ROOT.kRed+0,    20, 1.6),
        ("S0_Raw",   "L1HGCal3DS0$",         ROOT.kGreen+3,  21, 1.3),
        ("S0_Corr",  "L1HGCal3DS0Corr$",     ROOT.kGreen+1,  20, 1.3),
        ("T2_Raw",   "L1HGCal3DT2$",         ROOT.kAzure+2,  21, 1.0),
        ("T2_Corr",  "L1HGCal3DT2Corr$",     ROOT.kAzure+8,  20, 1.0),
        ("Akt_Raw",  "L1HGCal3DAKT12$",      ROOT.kViolet-1, 21, 0.8),
        ("Akt_Corr", "L1HGCal3DAKT12Corr$",  ROOT.kViolet-3, 20, 0.8),
    ]),
    ('test-hgc3b',[
        ("Ref_Corr", "L1HGCal3DRefCorr$",    ROOT.kRed+0,    20, 1.6),
        ("S0_Corr",  "L1HGCal3DS0Corr$",     ROOT.kGreen+1,  20, 1.3),
    ...
    ('test-hgc4',[
        ("Ref_Calo",  "L1CaloRef$",     ROOT.kRed+0,    20, 1.6),
        ("Ref_PF",    "L1PFRef$",       ROOT.kRed+2,    33, 1.7),
        ("S0_Calo",   "L1CaloS0$",      ROOT.kGreen+1,  20, 1.3),
        ("S0_PF",     "L1PFS0$",        ROOT.kGreen+3,  33, 1.5),
        ("T2_Calo",   "L1CaloT2$",      ROOT.kAzure+8,  20, 1.0),
        ("T2_PF",     "L1PFT2$",        ROOT.kAzure+2,  33, 1.2),
        ("Akt_Calo",  "L1CaloAKT12$",   ROOT.kViolet-3, 20, 0.8),
        ("Akt_PF",    "L1PFAKT12$",     ROOT.kViolet-1, 33, 1.0),
    ]),
    ('test-hgc4b',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  21, 1.2),
        ("PF Ref",    "L1PFRef$",       ROOT.kRed+0,    20, 1.6),
        ("PF S0",     "L1PFS0$",        ROOT.kGreen+1,  20, 1.3),
        ("PF T2",     "L1PFT2$",        ROOT.kAzure+8,  20, 1.0),
        ("PF Akt",    "L1PFAKT12$",     ROOT.kViolet-3, 20, 0.8),
    ]),
    ('test-hgc5',[
        ("Ref_PF",  "L1PFRef$",     ROOT.kRed+0,    20, 1.6),
        ("Ref_Puppi",    "L1PuppiRef$",       ROOT.kRed+2,    33, 1.7),
        ("S0_PF",   "L1PFS0$",      ROOT.kGreen+1,  20, 1.3),
        ("S0_Puppi",     "L1PuppiS0$",        ROOT.kGreen+3,  33, 1.5),
        ("T2_PF",   "L1PFT2$",      ROOT.kAzure+8,  20, 1.0),
        ("T2_Puppi",     "L1PuppiT2$",        ROOT.kAzure+2,  33, 1.2),
        ("Akt_PF",  "L1PFAKT12$",   ROOT.kViolet-3, 20, 0.8),
        ("Akt_Puppi",    "L1PuppiAKT12$",     ROOT.kViolet-1, 33, 1.0),
    ]),
    ('test-hgc5b',[
        ("Gen #times HGCAcc",        "HGCGenAcc$",    ROOT.kGray+1,  21, 1.2),
        ("Puppi Ref",    "L1PuppiRef$",       ROOT.kRed+0,    20, 1.6),
        ("Puppi S0",     "L1PuppiS0$",        ROOT.kGreen+1,  20, 1.3),
        ("Puppi T2",     "L1PuppiT2$",        ROOT.kAzure+8,  20, 1.0),
        ("Puppi Akt",    "L1PuppiAKT12$",     ROOT.kViolet-3, 20, 0.8),
    ]),
    ('l1pfold',[
